...
combined_plot <- ggplot(combined_data, aes(x = fop, y = normalized_fitness, color = group)) +
  geom_point(shape = 16, size = 3) +
  geom_smooth(method = "lm", se = FALSE, size = 0.75) +
  labs(x = "FOP", y = sprintf("Gene %s Fitness (doublings per hour)", gene_name), color = "Parameter Scaling") +
  theme_minimal() +
...
if (SAVE_FIGS) {
  save_plot(sprintf("analysis/figures/revised_fopXfitness_scaling_pref_%.1f.pdf", pref_val), combined_plot, base_width = 12, base_height = 6)
}
```
