...
if (SAVE_FIGS) {
  save_plot(sprintf("analysis/figures/revised_fopXfitness_weighted_opt%.1f_nonopt%.2f_dynamic_ribospeed%.4f.pdf", opt_val, nonopt_val, ribo_speed), combined_plot, base_width = 10, base_height = 8)
}
```
