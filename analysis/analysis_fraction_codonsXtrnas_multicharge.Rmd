...
for (output_dir in output_dirs) {
  ...
  data <- load_sim(file_paths$full_path)
...
# Create the plot
avg_plot <- ggplot(avg_tRNAfractionCharged, aes(x = fop, y = avg_charged / (avg_charged + avg_total), color = type, linetype = as.factor(charge))) +
  geom_line() +
  geom_point() +
  theme_minimal() +
