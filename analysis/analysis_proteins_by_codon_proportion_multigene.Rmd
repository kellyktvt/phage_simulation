---
title: "Average proteins for multiple genes by codon proportion"
...
if (SAVE_FIGS) {
  save_plot(sprintf("analysis/figures/avg_multigene_proteins_by_codon_proportion_%ds_pref%.1f_charge%d.pdf", max_time, pref_val, charge_val), avg_plot, base_width = 12, base_height = 12)
}
```