---
title: "Fraction of Optimal Codons x Avg Proteins for Gene 10A"
...
# Calculate average proteins for each proportion at 825 seconds
...
avg_plot_825 <- ggplot(avg_proteins_825, aes(x = fop, y = avg_protein)) +
  ...
  geom_point() +
  theme_minimal() +
  labs(x = "Fraction of Optimal Codons", y = "Average Proteins at 825s for gene 10A") +
  scale_x_continuous(breaks = seq(1, 9, by = 1), labels = seq(0.1, 0.9, by = 0.1))


if (SAVE_FIGS) {
  save_plot("analysis/figures/avg_gene10proteins_by_codon_proportion_825s.pdf", avg_plot_825, base_width = 12, base_height = 16)
}
```