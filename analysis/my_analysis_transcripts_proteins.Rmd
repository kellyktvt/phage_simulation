---
title: "TRNA Model Transcript/Protein Analysis"
...
data <- load_sim("data/simulation/phage/trna_phage_wildtype.tsv")
...
if (SAVE_FIGS) {
  save_plot("analysis/figures/trna_proteins_9010_900.pdf", bar_sim_plot, base_width = 8, base_height = 3)
