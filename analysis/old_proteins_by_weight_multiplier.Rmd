---
title: "Old Model - Protein Abundance by Weight Multiplier"
...
if (SAVE_FIGS) {
  save_plot(sprintf("analysis/figures/old_gene%sproteins_by_weight_multiplier_%ds.pdf", gene_name, max_time), plot, base_width = 6, base_height = 6)
}
```