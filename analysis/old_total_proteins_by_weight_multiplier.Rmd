---
title: "Old Model - Total Protein Abundance by Weight Multiplier"
...
if (SAVE_FIGS) {
  save_plot(sprintf("analysis/figures/old_total_proteins_by_weight_multiplier_%ds.pdf", max_time), plot, base_width = 6, base_height = 6)
}
```