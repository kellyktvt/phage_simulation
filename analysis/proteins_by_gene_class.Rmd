...
bar_sim_plot <- ggplot(data %>% filter(time == 1200), aes(x=factor(gene_number, gene_labels), 
...
if (SAVE_FIGS) {
  save_plot("analysis/figures/phage_wildtype_protein_barplot.pdf", bar_sim_plot, base_width = 8, base_height = 3)
  save_plot("analysis/figures/phage_wildtype_protein_lineplot.pdf", lineplot, base_height = 4, base_aspect_ratio = 1.7)
}
```