#!/bin/bash
#SBATCH -J revised_0.4     # job name
#SBATCH -o revised_0.4.o%j # output and error file name (%j expands to SLURM jobID)
...
export LAUNCHER_JOB_FILE=/work/10081/kellyktvt/ls6/phage_simulation/src/python/models/trna_phage_model/jobs_revised_dynamic_0.4.txt
