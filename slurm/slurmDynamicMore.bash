#!/bin/bash
#SBATCH -J more-ribospeeds     # job name
#SBATCH -o more-ribospeeds.o%j # output and error file name (%j expands to SLURM jobID)
...
export LAUNCHER_JOB_FILE=/work/10081/kellyktvt/ls6/phage_simulation/src/python/models/trna_phage_model/jobs_revised_dynamic_more.txt
