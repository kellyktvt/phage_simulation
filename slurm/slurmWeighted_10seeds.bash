#!/bin/bash
#SBATCH -J revised_weighted     # job name
#SBATCH -o revised_weighted.o%j # output and error file name (%j expands to SLURM jobID)
...
export LAUNCHER_JOB_FILE=/work/10081/kellyktvt/ls6/phage_simulation/src/python/models/weighted_phage_model/jobs_revised_weighted.txt
