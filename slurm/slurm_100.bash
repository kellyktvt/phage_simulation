#!/bin/bash
#SBATCH -J trna-charge-100     # job name
#SBATCH -o trna-charge-100.o%j # output and error file name (%j expands to SLURM jobID)
...
export LAUNCHER_JOB_FILE=/work/10081/kellyktvt/ls6/phage_simulation/src/python/models/trna_phage_model/jobs_codons_100.txt
